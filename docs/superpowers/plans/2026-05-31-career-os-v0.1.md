...
| 5 | 12–14 Agent 骨架 | ⚠️ | `4b3fcb9`；Worker **无 ReAct 子图** |
| 6 | 15–19 Workers | ⚠️ | `8569c71`；**规则桩**，非真 LLM |
| 7 | 20–21 API/SSE | ⚠️ | `8569c71`/`7f7af0d`；缺 `task_snapshot` SSE |
| 8 | 22–23 前端 | ✅ | `7f7af0d` |
| 9 | 24 browser_fetch | ✅ | 含于 workers commit |
| 9 | 25 Eval | ⚠️ | `tests/eval/CASES.md` + 77 pytest；golden stub；Commit 待提交 |

**测试：** `77 passed`（`uv run pytest tests/ -q`，2026-05-31）· **main @ `7f7af0d`**
